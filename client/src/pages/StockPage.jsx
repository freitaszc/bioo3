      ...
      <main className="page-shell stock-page">
        <section className="page-heading">
          ...
          <div className="inventory-toolbar">
            <button className="secondary-button" type="button" onClick={() => openAdvancedModal("lot")}>Cadastrar produto</button>
            <button className="secondary-button" type="button" onClick={() => openAdvancedModal("movement")}>Movimentar estoque</button>
            <button className="secondary-button" type="button" onClick={() => openAdvancedModal("supplier")}>Fornecedores</button>
            <button className="secondary-button" type="button" onClick={() => openAdvancedModal("history")}>Ver histórico</button>
          </div>
        </section>

        <section className="panel">
          <div className="inventory-overview">
            {advancedLoading ? <SummarySkeleton /> : <div className="summary-grid"><div><strong>{suppliers.length}</strong><span>Fornecedores</span></div><div><strong>{lots.length}</strong><span>Lotes</span></div><div><strong>{movements.length}</strong><span>Movimentações recentes</span></div></div>}
          </div>
