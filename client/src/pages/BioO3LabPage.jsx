...
const conflictRawValuePrefix = "__BATCH_CONFLICT__:";
...
function conflictingValues(rawValue) {
  if (!String(rawValue || "").startsWith(conflictRawValuePrefix)) return [];
  return String(rawValue)
    .slice(conflictRawValuePrefix.length)
    .split("|")
