...
function isMinor(age) {
  // Zero represents an unidentified age in the current patient records.
  return Number(age) > 0 && Number(age) < 18;
}
    ...
    printWindow.document.write(`
      ...
      <html>
        ...
        <body>
          ...
          ${isMinor(patient.age) ? "<p><strong>Atenção: paciente menor de 18 anos.</strong></p>" : ""}
