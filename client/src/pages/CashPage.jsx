...
export default function CashPage() {
  ...
  function openSale() {
    setSaleForm(emptySale()); setMessage(""); setError(""); setSaleError(""); setSaleModal(true);
  }
  ...
  async function submitSale(event) {
    event.preventDefault(); setError(""); setMessage(""); setSaleError("");
    ...
    try {
      ...
      setMessage(data.warnings?.length ? `Venda registrada com alerta: ${data.warnings.join(" ")}` : "Venda registrada com sucesso.");
      await load();
    } catch (err) {
